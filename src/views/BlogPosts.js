    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        <Row noGutters className="page-header py-4">
          <PageTitle title="Farmacias Cadastradas"  className="text-sm-left mb-3" />
        </Row>
        {/* Default Light Table */}
        <Row>
          <Col>
            <Card small className="mb-4">
              <CardHeader className="border-bottom">
                <h6 className="m-0">Estabeleciemtos disponíveis</h6>
              </CardHeader>
              <CardBody className="p-0 pb-3">
                <table className="table mb-0">
                  ...
                  <tr>
                    <td>Farma Mais</td>
                    <td>Rua Alexandre Brandão, 155. Centro. Belo Horizonte, Minas Gerais.</td>
                  </tr>
                  <tr>
                    <td>Super Far</td>
                    <td>Rua Alexandre Brandão, 155. Centro. Belo Horizonte, Minas Gerais.</td>
